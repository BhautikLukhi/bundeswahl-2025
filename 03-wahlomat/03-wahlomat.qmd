...
selected_parties <- c(selected_parties, "Volt")
...
df |> 
  ...
  scale_fill_manual(values = c(color_pal[7], "grey70", "pink")) +
  labs(
    title = "Antworten der Parteien zu den Thesen des Wahl-O-Mat",
    caption = "Daten: Wahl-O-Mat (via github.com/gockelhahn/qual-o-mat-data/).
