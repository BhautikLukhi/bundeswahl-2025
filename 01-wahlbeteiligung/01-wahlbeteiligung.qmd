...
```{r wbt-altersgruppen-animation, gganimate = list(nframes = 100, fps = 12), fig.width=6, fig.height=5, fig.dpi=150, cache=FALSE}
...
```{r wbt-altersgruppen-geschlecht-animation, gganimate = list(nframes = 100, fps = 12), fig.width=6, fig.height=5, fig.dpi=150, cache=FALSE}
p <- df_wbt_total_ab1972 |> 
  filter(altersgruppe != "Summe", geschlecht != "Summe") |> 
