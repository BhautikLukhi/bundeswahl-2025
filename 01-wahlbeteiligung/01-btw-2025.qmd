...
#   group_by(wahl, altersgruppe) |> 
#   filter(geschlecht == "Summe", wahl >= 1972) |> 
#   # mutate(altersgruppe = fct_inorder(altersgruppe)) |> 
#   pivot_wider(id_cols = "wahl", names_from = "altersgruppe", values_from = "wahlbeteiligung") |> gt()
```
...
animate(p_anim, fps = 10, nframes = 100, end_pause = 10)
```
