...
df_informationsquellen |> 
  ...
  labs(
    ...
    subtitle = "Nutzungshäufigkeit verschiedener Informationsquellen über den Wahlkampf und<br>die Parteien zur Europawahl",
    caption = sprintf(
  ...
  theme(
    strip.text = element_textbox(
      family = "Roboto Condensed SemiBold", size = 10, width = 0.8, height = 0.12, 
...
df_informationsquellen |>
  ...
  labs(
    ...
    caption = sprintf(
      "Daten: FES, Jugendwahlstudie zur Europawahl 2024 (%s Befragte zwischen 15 und 20<br>
...
df_marimekko |> 
  ...
  labs(
    ...
    caption = sprintf(
      ...
      der vergangenen<br>Woche gesehen haben: Wie häufig hatten diese einen Bezug zu
      Politikerinnen und Politikern, Parteien oder<br>politischen Themen zur Europawahl?
      <br><br>
