...
p_beeswarm_2021 <- df_wk_abstand |> 
  ...
  annotate(
    ...
    y = 1.25,
    label = c(
      "Diese 5 Direktmandate wurden\nmit den geringsten Stimmen-\nanteilen in der Geschichte der\nBundesrepublik erlangt.",
      "Einem einzigen Direktkandidaten\ngelang es, mehr als 50 % der\nStimmen zu erreichen"),
    family = "Roboto Condensed", size = 3.5, hjust = 0, lineheight = 0.9
  ) +
  annotate(
    GeomCurve,
    # x = c(0.52, 0.23), 
...
p_beeswarm_1980 <- df_wk_abstand |> 
  ...
  labs(
    # title = "Erststimmenanteile der Wahlkreisgewinner 1980",
    title = "1980",
    # subtitle = "Jeder Punkt ist ein Wahlkreis",
    x = "Erststimmenanteil (%)",
    fill = NULL, shape = NULL
...
```{r plot-beeswarm-2021-1980-kombi, fig.width=6, fig.height=6}
