...
df_uebereinstimmungen |> 
  ...
  annotate(
    ...
    size = 3, lineheight = 0.8, hjust = 0, family = "Roboto Condensed"
  ) +
  annotate(
    GeomCurve,
  ...
  labs(
    title = "Titel",
    subtitle = "Anteil der Stimmen der Länder im Bundesrat",
    caption = "**TODO** Kriterium: Koalition auf Landesebene stimmt mit Bund überein oder  Alleinregierung eines der Partner im Bund.<br><br>
