...
p <- df_dawum |> 
  ...
  group_by(Institute_Name, election_year, days_until_election, Party_Shortcut) |> 
  summarize(share = mean(Share), .groups = "drop") |> 
  ...
  labs(
    ...
    subtitle = sprintf("Geglättete Stimmenanteile (%%) im Vorfeld der Bundestagswahlen
